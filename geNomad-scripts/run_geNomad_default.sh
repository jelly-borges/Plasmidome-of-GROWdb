...
outputdir="/scratch/chris/geNomad/genomad_output"
...
# run it!  
# splits shrinks database size to 4 chunks to reduce memory footprint
# cleanup removes intermediate files
mkdir -p ${outputdir}/${sample}
genomad end-to-end --splits 4 --cleanup --threads 8 $inputpath ${outputdir}/${sample} $genomad_db
