...
alderaanwdir="/storage/biology/projects/guatneyl/GROWmegahit1k"
samplenamespath="${alderaanwdir}/list_of_samples_158_megahit_assembly_paths.txt"
...
do
    ...
    #path to 1k trimmed megahit file on miller-lab
    ...
    if [ ! -f ${alderaanwdir}/${sample}_B_1000.fa ]
